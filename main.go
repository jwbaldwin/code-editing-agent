...
func (a *Agent) executeTool(toolID string, toolName string, input json.RawMessage) anthropic.ContentBlockParamUnion {
	...
	return anthropic.NewToolResultBlock(toolID, response, false)
}
